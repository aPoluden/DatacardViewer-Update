class Datacard():
    ...
    def barcode(self, bin, proc, idx) :
        ...
        three elements: [0] path to the file that contains the shapes, [1] path to the shape histogram in the
        input file, [2] path to the uncertainty shape histograms in the input file. The elements of the list are returned
